...
const AdminSidebar = ({ isOpen, onClose }) => {
    ...
    const menuItems = [
        ...
        { label: 'طلبات السحب', icon: 'document-text', path: '/admin/withdrawals' },
    ...
    return (
        <>
            ...
            <aside
                className={`
                    w-64 bg-primary text-white flex flex-col h-screen fixed right-0 top-0 overflow-y-auto z-40
            ...
            >
                ...
                <div className="p-4 mt-auto border-t border-white/10 space-y-2">
                    ...
                    <Button
                        ...
                        variant="ghost"
                        className="w-full !px-4 !py-3 !rounded-lg !text-red-400 hover:!bg-red-400/10 hover:!text-red-300 transition-colors !justify-start"
                        icon={
                            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                            </svg>
                        }
                        children={<span>تسجيل الخروج</span>}
                    >
                    </Button>
